/* ==========================================================
   Warrior & Wealth — Web Client — 08-main.js
   ----------------------------------------------------------
   Bootstrap — va caricato PER ULTIMO in index.html, dopo tutti
   gli altri file (00-core.js ... 07-citta.js): a questo punto
   WW.renderStruttureListForm/WW.renderUnitaForm/WW.renderSbloccoUnita
   (06-costruzione.js) e WW.renderCittaList (07-citta.js) esistono
   già, quindi la prima chiamata a WW.renderAllFromServer() (definita
   in 04-game-main.js) trova tutto pronto.

   Ordine completo degli <script> in index.html:
     00-core.js, 01-net.js, 02-auth.js, 03-nav.js, 04-game-main.js,
     05-scambio.js, 06-costruzione.js, 07-citta.js, 08-main.js
