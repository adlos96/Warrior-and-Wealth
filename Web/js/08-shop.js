...
(function (WW) {
  ...
  const SHOP_CATEGORIE = [
    {
      ...
      items: [
        { nome: "VIP 24H", comandoServer: "Vip_1", costoChiave: "Pacchetto_Vip_1_Costo", rewardChiave: "Pacchetto_Vip_1_Reward", rewardUnit: "h", valuta: "viola", funzionale: true, descChiave: "Shop Vip 1" },
        { nome: "VIP 24H", comandoServer: "Vip_2", costoChiave: "Pacchetto_Vip_2_Costo", rewardChiave: "Pacchetto_Vip_2_Reward", rewardUnit: "h", valuta: "usdt", funzionale: false, descChiave: "Shop Vip 2" },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        { nome: "Costruttori 24H", comandoServer: "Costruttori_24H", costoChiave: "Pacchetto_Costruttore_24h_Costo", rewardChiave: "Pacchetto_Costruttore_24h_Reward", rewardUnit: "h", valuta: "blu", funzionale: true, descChiave: "Shop Costruttore 24h" },
        { nome: "Costruttori 48H", comandoServer: "Costruttori_48H", costoChiave: "Pacchetto_Costruttore_48h_Costo", rewardChiave: "Pacchetto_Costruttore_48h_Reward", rewardUnit: "h", valuta: "blu", funzionale: true, descChiave: "Shop Costruttore 48h" },
      ],
    },
    {
      titolo: "Reclutatori",
      ...
      items: [
        { nome: "Reclutatori 24H", comandoServer: "Reclutatori_24H", costoChiave: "Pacchetto_Reclutatore_24h_Costo", rewardChiave: "Pacchetto_Reclutatore_24h_Reward", rewardUnit: "h", valuta: "blu", funzionale: true, descChiave: "Shop Reclutatore 24h" },
        { nome: "Reclutatori 48H", comandoServer: "Reclutatori_48H", costoChiave: "Pacchetto_Reclutatore_48h_Costo", rewardChiave: "Pacchetto_Reclutatore_48h_Reward", rewardUnit: "h", valuta: "blu", funzionale: true, descChiave: "Shop Reclutatore 48h" },
      ],
    },
    {
      ...
      items: [
        { nome: "Scudo della Pace 8H", comandoServer: "Scudo_Pace_8H", costoChiave: "Pacchetto_Scudo_Pace_8h_Costo", rewardChiave: "Pacchetto_Scudo_Pace_8h_Reward", rewardUnit: "h", valuta: "blu", funzionale: true, descChiave: "Shop Scudo Pace 8h" },
        { nome: "Scudo della Pace 24H", comandoServer: "Scudo_Pace_24H", costoChiave: "Pacchetto_Scudo_Pace_24h_Costo", rewardChiave: "Pacchetto_Scudo_Pace_24h_Reward", rewardUnit: "h", valuta: "blu", funzionale: true, descChiave: "Shop Scudo Pace 24h" },
        { nome: "Scudo della Pace 72H", comandoServer: "Scudo_Pace_72H", costoChiave: "Pacchetto_Scudo_Pace_72h_Costo", rewardChiave: "Pacchetto_Scudo_Pace_72h_Reward", rewardUnit: "h", valuta: "blu", funzionale: true, descChiave: "Shop Scudo Pace 72h" },
      ],
    },
    {
      titolo: "GamePass",
      items: [
        { nome: "GamePass Silver", comandoServer: "GamePass_Base", costoChiave: "Pacchetto_GamePass_Base_Costo", rewardChiave: "Pacchetto_GamePass_Base_Reward", rewardUnit: "g", valuta: "usdt", funzionale: false, descChiave: "Shop GamePass Base" },
        { nome: "GamePass Gold", comandoServer: "GamePass_Avanzato", costoChiave: "Pacchetto_GamePass_Avanzato_Costo", rewardChiave: "Pacchetto_GamePass_Avanzato_Reward", rewardUnit: "g", valuta: "usdt", funzionale: false, descChiave: "Shop GamePass Avanzato" },
      ],
    },
  ];
  ...
  // Badge rotondo in cima alla card: usa la stessa icona della valuta già
  // mostrata nel prezzo (Diamante Viola/Blu/USDT). Migliorata su richiesta
  // dell'utente (13/09/2026: "più spessore e una grafica migliore") —
  // assets/USDT_Logo.png è il logo ufficiale fornito dall'utente stesso
  // (prima, non avendolo, c'era un monogramma "T" disegnato a mano).
