...
namespace Server_Strategico.Gioco
{
    internal class Battaglie
    {
        public static async Task<bool> Battaglia_Barbari(Player player, Guid clientGuid, string tipo, string livello)
        {
            ...
            dannoInflitto += CalcolareDanno_Giocatore(arcieri[0], catapulte[0], guerrieri[0], picchieri[0], player, clientGuid) / tipi_Di_Unità_Att;
            dannoInflitto += CalcolareDanno_Giocatore(arcieri[1], catapulte[1], guerrieri[1], picchieri[1], player, clientGuid) / tipi_Di_Unità_Att;
            dannoInflitto += CalcolareDanno_Giocatore(arcieri[2], catapulte[2], guerrieri[2], picchieri[2], player, clientGuid) / tipi_Di_Unità_Att;
            dannoInflitto += CalcolareDanno_Giocatore(arcieri[3], catapulte[3], guerrieri[3], picchieri[3], player, clientGuid) / tipi_Di_Unità_Att;
            ...
            arcieri_Temp[0]     = RidurreNumeroSoldati(arcieri[0], dannoInflittoDalNemico * 0.70, (Esercito.Unità.Arcere_1.Difesa + Ricerca.Soldati.Incremento.Difesa * player.Arcere_Difesa) * arcieri[0], Esercito.Unità.Arcere_1.Salute + Ricerca.Soldati.Incremento.Salute * player.Arcere_Salute);
            ...
            arcieri_Temp[1]  = RidurreNumeroSoldati(arcieri[1], dannoInflittoDalNemico * 0.70, (Esercito.Unità.Arcere_2.Difesa + Ricerca.Soldati.Incremento.Difesa * player.Arcere_Difesa) * arcieri[1], Esercito.Unità.Arcere_2.Salute + Ricerca.Soldati.Incremento.Salute * player.Arcere_Salute);
            ...
            arcieri_Temp[2] = RidurreNumeroSoldati(arcieri[2], dannoInflittoDalNemico * 0.70, (Esercito.Unità.Arcere_3.Difesa + Ricerca.Soldati.Incremento.Difesa * player.Arcere_Difesa) * arcieri[2], Esercito.Unità.Arcere_3.Salute + Ricerca.Soldati.Incremento.Salute * player.Arcere_Salute);
            ...
            arcieri_Temp[3] = RidurreNumeroSoldati(arcieri[3], dannoInflittoDalNemico * 0.70, (Esercito.Unità.Arcere_4.Difesa + Ricerca.Soldati.Incremento.Difesa * player.Arcere_Difesa) * arcieri[3], Esercito.Unità.Arcere_4.Salute + Ricerca.Soldati.Incremento.Salute * player.Arcere_Salute);
            ...
            arcieri_Temp[4] = RidurreNumeroSoldati(arcieri[4], dannoInflittoDalNemico * 0.70, (Esercito.Unità.Arcere_5.Difesa + Ricerca.Soldati.Incremento.Difesa * player.Arcere_Difesa) * arcieri[4], Esercito.Unità.Arcere_5.Salute + Ricerca.Soldati.Incremento.Salute * player.Arcere_Salute);
            ...
            picchieri_Temp_Enemy[0] = RidurreNumeroSoldati(picchieri_Enemy[0], dannoInflitto, Esercito.EsercitoNemico.Lanceri_1.Difesa * picchieri_Enemy[0], Esercito.EsercitoNemico.Lanceri_1.Salute);
            arcieri_Temp_Enemy[0] = RidurreNumeroSoldati(arcieri_Enemy[0], dannoInflitto, Esercito.EsercitoNemico.Arceri_1.Difesa * arcieri_Enemy[0], Esercito.EsercitoNemico.Arceri_1.Salute);
            catapulte_Temp_Enemy[0] = RidurreNumeroSoldati(catapulte_Enemy[0], dannoInflitto, Esercito.EsercitoNemico.Catapulte_1.Difesa * catapulte_Enemy[0], Esercito.EsercitoNemico.Catapulte_1.Salute);
        ...
        public static async Task<bool> Battaglia_PVP(Player player, Guid clientGuid, Player player2, Guid clientGuid2)
        {
            ...
            dannoInflittoDalNemico += CalcolareDanno_Giocatore(arcieri[0], catapulte[0], guerrieri[0], picchieri[0], player, clientGuid) / tipi_Di_Unità_Att; //Difensore
            dannoInflittoDalNemico += CalcolareDanno_Giocatore(arcieri[1], catapulte[1], guerrieri[1], picchieri[1], player, clientGuid) / tipi_Di_Unità_Att;
            dannoInflittoDalNemico += CalcolareDanno_Giocatore(arcieri[2], catapulte[2], guerrieri[2], picchieri[2], player, clientGuid) / tipi_Di_Unità_Att;
            dannoInflittoDalNemico += CalcolareDanno_Giocatore(arcieri[3], catapulte[3], guerrieri[3], picchieri[3], player, clientGuid) / tipi_Di_Unità_Att;
        ...
        public static double CalcolareDanno_Giocatore(int arcieri, int catapulte, int guerrieri, int picchieri, Player player, Guid guid)
        {
            ...
            {
                Send(guid, $"Log_Server|Gli arceri e le catapulte del giocatore subiscono una riduzione del danno per mancanza di frecce [{arcieri * Esercito.Unità.Arcere_1.Componente_Lancio + catapulte * Esercito.Unità.Catapulta_1.Componente_Lancio}/{player.Frecce}]:");
            ...
            else
            {
                ...
                Send(guid, $"Log_Server|Frecce utilizzate: {arcieri * Esercito.Unità.Arcere_1.Componente_Lancio + catapulte * Esercito.Unità.Catapulta_1.Componente_Lancio}/{player.Frecce}");
            }
