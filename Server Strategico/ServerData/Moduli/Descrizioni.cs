    ...
    internal class Descrizioni
    {
        public static async void DescUpdate(Player player)
        {
            Send(player.guid_Player, $"Descrizione|Fattoria|[black]" +
                $"La fattoria è la struttura principale per la produzione di Cibo [icon:cibo], fondamentale per la costruzione di edifici militari e civili, " +
            ...
            Send(player.guid_Player, $"Descrizione|Segheria|[black]" +
               $"La Segheria è la struttura principale per la produzione di Legna [icon:legno], fondamentale per la costruzione di strutture militari, civili e " +
            ...
            Send(player.guid_Player, $"Descrizione|Cava di Pietra|[black]" +
                $"La cava di pietra è la struttura principale per la produzione di Pietra [icon:pietra], fondamentale per la costruzione di strutture militari, cilivi e " +
                $"l'addestramento delle unità militari. Indispensabile per la ricerca tecnologica e di componenti militari\n\n" +
                $"Costo Costruzione:\n" +
            ...
            Send(player.guid_Player, $"Descrizione|Miniera di Ferro|[black]" +
                $"La Miniera di ferro è la struttura principale per la produzione di Ferro [icon:ferro], fondamentale per la costruzione di strutture militari, cilivi e " +
                $"l'addestramento delle unità militari. Indispensabile per la ricerca tecnologica e di componenti militari\n\n" +
                $"Costo Costruzione:\n" +
            ...
            Send(player.guid_Player, $"Descrizione|Miniera d'Oro|[black]" +
                $"La miniera d'oro è la struttura principale per la produzione dell'Oro [icon:oro], fondamentale per la costruzione di strutture militari, civili e " +
                $"l'addestramento delle unità militari. Indispensabile per la ricerca tecnologica e di componenti militari\n\n" +
                $"Costo Costruzione:\n" +
            ...
            Send(player.guid_Player, $"Descrizione|Case|[black]" +
                $"Le Case sono necessarie per attirare sempre più cittadini [icon:popolazione], verso il vostro villaggio, " +
            ...
            Send(player.guid_Player, $"Descrizione|Produzione Spade|[black]" +
                 ...
                 $"essenziali per l'addestramento di unità militari, questa struttura produce Spade [icon:spade].\n\n" +
                 $"Costo Costruzione:\n" +
            ...
            Send(player.guid_Player, $"Descrizione|Produzione Lance|[black]" +
                ...
                $"essenziali per l'addestramento di unità militari, questa struttura produce Lancie [icon:lance].\n\n" +
                $"Costo Costruzione:\n" +
            ...
            Send(player.guid_Player, $"Descrizione|Produzione Archi|[black]" +
                ...
                $"essenziali per l'addestramento di unità militari, questa struttura produce Archi [icon:archi].\n\n" +
                $"Costo Costruzione:\n" +
            ...
            Send(player.guid_Player, $"Descrizione|Produzione Scudi|[black]" +
                ...
                $"essenziali per l'addestramento di unità militari, questa struttura produce Scudi [icon:scudi].\n\n" +
                $"Costo Costruzione:\n" +
            ...
            Send(player.guid_Player, $"Descrizione|Produzione Armature|[black]" +
                ...
                $"essenziali per l'addestramento di unità militari, questa struttura produce Armature [icon:armature].\n\n" +
                $"Costo Costruzione:\n" +
            ...
            Send(player.guid_Player, $"Descrizione|Produzione Frecce|[black]" +
                ...
                $"essenziali per l'addestramento di unità militari, questa struttura produce Frecce [icon:frecce].\n\n" +
                $"Costo Costruzione:\n" +
            ...
            Send(player.guid_Player, $"Descrizione|Scudi|[black]Gli Scudi[icon:scudi] sono necessari per l'addestramento delle unità.\n\n");
            Send(player.guid_Player, $"Descrizione|Armature|[black]Le Armature[icon:armature] sono necessarie per l'addestramento delle unità.\n\n");
